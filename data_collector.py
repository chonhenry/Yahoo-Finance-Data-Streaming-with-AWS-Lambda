...
def lambda_handler(event, context):
    ...
    end_date = '2020-05-15'
    interval = '1m'
    company_arr = ['fb', 'shop', 'bynd', 'nflx', 'pins', 'sq', 'ttd', 'okta', 'snap', 'ddog']
    ...
    for company in company_arr:
        ...
        for index, rows in download.iterrows():
            ...
            fh.put_record(DeliveryStreamName="project-3-delivery-stream", Record={"Data": as_jsonstr.encode('utf-8')})
